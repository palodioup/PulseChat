  ...
  return (
    <div>
      <div className='text-center m-5'>
        <h1 className="text-7xl tracking-tighter font-small">Seamlessly <span className="text-pink-500">chat</span> with <span className="text-cyan-500">friends</span> like never before.</h1>
      </div>
      <div className="flex justify-center items-center">
  {/* Cyan Button with Glow */}
  <button 
